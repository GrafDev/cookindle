...
export const CONFIG = {
    ...
    cookie: {
        ...
        pieces: {
            // Настройки для шестиугольной сетки (устаревшие)
            ...
            maxFallingPieces: 8, // Максимальное количество кусочков, которые выпадают при одном клике
            // Настройки для диаграммы Вороного
            useVoronoi: true, // Использовать диаграмму Вороного вместо шестиугольной сетки
            voronoi: {
                seedCount: 60, // Количество точек-семян для генерации ячеек
                boundaryPointsRatio: 0.25, // Доля точек на границе (0.25 = 25%)
                innerPointsRadius: 0.85, // Радиус для внутренних точек (0.85 = 85% от радиуса печенья)
                minCellSize: 0.02, // Минимальный размер ячейки (в процентах от радиуса печенья)
                relaxationIterations: 5 // Количество итераций релаксации Ллойда для улучшения качества
            },
            chipAnimation: {
