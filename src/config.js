...
export const CONFIG = {
    ...
    centerShape: {
        ...
        borderRadius: 20, // Радиус скругления углов для квадрата и треугольника
        ...
        // Параметры градиентного углубления
        gradient: {
            enabled: true, // Включить градиентный эффект углубления
            width: 10, // Ширина градиентной полосы (в пикселях)
            innerColor: 0x8B4513, // Внутренний цвет (темно-коричневый)
            outerColor: 0xD2691E, // Внешний цвет (цвет печенья)
            innerAlpha: 0.7, // Прозрачность внутреннего цвета
            outerAlpha: 0.0 // Прозрачность внешнего цвета (прозрачный)
        },
        // Параметры внешнего градиента (выпуклость)
        outerGradient: {
            enabled: true, // Включить внешний градиентный эффект
            width: 8, // Ширина градиентной полосы (в пикселях)
            innerColor: 0x8B4513, // Внутренний цвет (темно-коричневый)
            outerColor: 0xD2691E, // Внешний цвет (цвет печенья)
            innerAlpha: 0.7, // Прозрачность внутреннего цвета
            outerAlpha: 0.0 // Прозрачность внешнего цвета (прозрачный)
