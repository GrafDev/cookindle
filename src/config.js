...
export const CONFIG = {
    ...
    cookie: {
        ...
        pieces: {
            ...
            polygonSides: 8, // Количество углов у многоугольников (6 = шестиугольник, 9 = девятиугольник)
            sizeMultiplier: 1.5, // Множитель размера многоугольников (1.0 = обычный размер, 1.1 = увеличено на 10%)
            randomRotation: true, // Случайный поворот каждого многоугольника
            maxFallingPieces: 131, // Максимальное количество кусочков, которые выпадают при одном клике
            chipAnimation: {
