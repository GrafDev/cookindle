...
export const CONFIG = {
    ...
    cookie: {
        ...
        pieces: {
            ...
            sizeMultiplier: 1.2, // Множитель размера многоугольников (1.0 = обычный размер, 1.1 = увеличено на 10%)
    ...
    centerShape: {
        ...
        // Параметры пунктирной обводки из кружков
        dashedBorder: {
            enabled: true, // Включить пунктирную обводку
            holeSize: 3, // Размер кружков
            spacing: 8 // Расстояние между кружками
        },
        // Параметры основной границы формы
        showMainBorder: false // Скрыть основную границу формы
    },
    ...
    // Dev настройки (отладочные элементы - только в development)
    dev: {
        showBorders: false, // Границы кусочков - скрыто
        showLabels: false, // Номера кусочков - скрыто
        consoleLogging: import.meta.env.DEV, // Логирование - только в dev
        ...
        showShapeButtons: import.meta.env.DEV, // Кнопки смены формы - только в dev
        // Показ разделенных кусочков с цветовой маркировкой
        showSplitPieces: false, // Цветовая маркировка - скрыто
        splitPieceColors: {
