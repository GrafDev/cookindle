...
export const CONFIG = {
    ...
    cookie: {
        ...
        pieces: {
            ...
            voronoi: {
                seedCount: 150, // Количество точек-семян для генерации ячеек (увеличено для лучшего покрытия)
                boundaryPointsRatio: 0.9, // Доля точек на границе (0.25 = 25%)
                innerPointsRadius: 0.2, // Радиус для внутренних точек (0.85 = 85% от радиуса печенья)
    ...
    centerShape: {
        form: 3, // 1 - круг, 2 - квадрат, 3 - треугольник
