...
export const CONFIG = {
    ...
    cookie: {
        ...
        pieces: {
            ...
            polygonSides: 6, // Количество углов у многоугольников (6 = шестиугольник, 9 = девятиугольник)
            ...
            maxFallingPieces: 155, // Максимальное количество кусочков, которые выпадают при одном клике
            chipAnimation: {
    ...
    transition: {
        fadeOut: {
            duration: 300, // Длительность исчезновения в мс
            easing: 'ease-out'
        },
        fadeIn: {
            duration: 400, // Длительность появления в мс
            easing: 'ease-in',
            delay: 100 // Задержка перед появлением в мс
        }
    },
